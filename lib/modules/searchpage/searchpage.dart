...
Future<dynamic> getLocationInfo(LatLng locationCordinates){
   return http
                          .post(Uri.parse(
      ...
      child: BlocConsumer<SearchCubit, SearchState>(
        listener: (context, state) { 
          ...
          if (state is SearchResultDone){
                showBottomSheet(context: context,enableDrag: true,backgroundColor: Colors.transparent, builder: (_)=>Container(constraints: BoxConstraints.loose(Size(double.infinity, 350)), decoration: BoxDecoration(color:Color.fromARGB(61, 0, 0, 0),borderRadius: BorderRadius.only(topLeft:Radius.circular(20) ,topRight:Radius.circular(20) ) ), child: ListView(shrinkWrap: true, children: BlocProvider.of<SearchCubit>(context).workersList.map((e) => workerListTileBuilder(e)).toList())));
          }
